        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="py-2">
                Bringing your ideas to life with stunning, responsive web applications.
              </p>
              ...
              <p className="text-gray-800 py-1">Laravel, MySQL</p>
            </div>
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              <Image src={consulting} width={100} height={100} />
              <h3 className="text-lg font-medium pt-8 pb-2">Consulting & Strategy</h3>
              <p className="py-2">
                Need guidance on your project? Let’s brainstorm strategies that drive success.
              </p>
              <h4 className="py-4 text-teal-600">Tools I Use</h4>
              <p className="text-gray-800 py-1">Google Meet, Zoom</p>
              <p className="text-gray-800 py-1">Miro, Figma</p>
            </div>
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              <Image src={design} width={100} height={100} />
              <h3 className="text-lg font-medium pt-8 pb-2">UI/UX Design</h3>
              <p className="py-2">
                Crafting user-centric designs that provide engaging experiences.
              </p>
